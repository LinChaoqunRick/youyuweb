...
var language_class = {
    ...
    summary: {
      ...
      tip: [
        ...
        },
        {
          ...
          con: 'Refresh the status information manually by clicking "Refresh" button.',
        },
        {
          title: "自动刷新",
  ...
  network: {
    ...
    interfaces: {
      ...
      cellular: {
        ...
        sim_setting: "SIM卡设置",
        setting: "设置",
        apn_unsave_tip: "未保存的配置将被丢弃，是否确认取消？",
        first_time_apn_tip: "首次使用多APN功能需要重启设备，是否重启？",
        tip: [
          {
            title: "蜂窝设置",
            con: "",
      ...
      switch: {
        ...
        ipv6: "IPv6地址",
        prefix_v6: "前缀长度",
        ipv6_prefix_v6_tip: "IPv6地址和前缀长度不能同时为空",
        mtu: "最大传输单元(MTU)",
        vlantitle: "VLAN设置",
        vid: "VLAN ID",
        port0: "FE 1/1",
      ...
      wlan: {
        ...
        tip: [
          ...
          {
            title: "最大客户端数量",
            con: "输入该SSID可允许连接的最大客户端数量.合法值：1-15",
          },
          {
            title: "射频类型",
    ...
    vpn: {
      ...
      wireguard: {
        ...
        ipAddressSameTip:
          "当前WireGuard接口与WireGuard_{}接口的IP地址不能完全一致",
        ipAddressSameSubnetTip:
          "当前WireGuard接口与WireGuard_{}接口的IP地址不能在同一个网段",
        address: "IP地址",
        listenPort: "监听端口",
        port: "端口",
        dns: "DNS",
        ...
        addressRequiredTip: '当端点端口填写时该选项必填',
        portRequiredTip: '当端点地址填写时该选项必填',
        tip: [
          {
            title: "WireGuard",
      ...
      zerotier: {
        ...
        resetTip:
          "重新生成 Node ID 将重置所有 ZeroTier 网络连接，可能需要一段时间完成。",
        add: "添加ZeroTier连接",
        edit: "编辑ZeroTier连接",
        disabled: "未启用",
        connecting: "正在连接",
    ...
    ippassthrough: {
      ...
      mode: '穿透模式',
      mac: 'MAC',
      enable_tip: '启用IP穿透功能将使所选接口链路更改为第一优先级的备份链路，是否确认？',
      disable_tip: '关闭IP穿透功能将使设备重启，是否确认？',
      tip: [
        {
          title: "启用",
          con: "启用 IP 穿透",
    ...
    routing: {
      ...
      routes: {
        ...
        gateway: "网关",
        distance: "距离",
        not_identical_route: "不允许配置相同的路由",
        tip: [
          {
            title: "目的网络",
            con: "输入需要到达的目的IP地址",
      ...
      policy: {
        ...
        priority: "优先级",
        source_subnet: "源子网",
        destination_subnet: "目的子网",
        outgoing_interface: "出接口",
        route_delete_tip: "是否确定删除该条策略路由？",
        not_identical_policy: "不允许配置完全相同的策略",
        not_special_purpose_ip: "不支持配置特殊用途的IP地址",
        tip: [
          {
            title: "优先级",
            con: "设定该条策略的优先级，数字越小优先级越高，可输入范围为1~255。"
          },
          {
            title: "源子网",
            con: "满足设定的源子网地址的流量才会被应用于该条策略。不填写则不匹配源子网。"
          },
          {
            title: "出接口",
            con: "同时满足源子网和目的子网的流量，将会从选择的接口转发出去。策略路由的优先级高于静态路由。"
          },
          {
            title: "目的子网",
            con: "满足设定的目的子网地址的流量才会被应用于该条策略。"
          },
        ]
      },
      rip: {
  ...
  system: {
    ...
    events: {
      ...
      events: {
        ...
        deleteall: "删除全部",
        alert:
          "当事件记录数目达到9000条后系统会自动删除最早的2000条。现记录数已达7000条，请删除无用的记录以免因系统自动删除而丢失数据。",
        tip: [
          {
            title: "标记为已读",
            con: "把选中的事件告警标记为已读",
  ...
  industrial: {
    ...
    modbusclient: {
      ...
      channel: {
        ...
        cmd6: "保持寄存器 (Float)",
        normalcon:
          "提示: $YEAR/$MON/$DAY $TIME，从通道$NAME的地址$ADDRESS 读取到正常数据$VALUE。(异常范围是$CONDITION)",
        abnormalcon:
          "提示: $YEAR/$MON/$DAY $TIME，从通道$NAME的地址$ADDRESS 读取到异常数据$VALUE。(异常范围是$CONDITION)",
        error1: "保存失败，请先配置串口为Modbus Client模式",
    ...
    dlms: {
      title: "DLMS",
      deleteTip: "确认删除“{name}”，删除后数据无法复原。",
      enabled: "启用",
      testTip: "正在测试${name}，请稍等...",
      testResultTip: "测试结束，下面是测试结果",
      testSuccess: "连接成功",
      testFailed: "连接失败",
      noData: "无数据返回",
      select_device: "请先选择物理设备",
      ...
      server: {
        ...
        blockcipherkey: "分组密钥",
        transport: "传输安全",
        InfinityvocationcounterOBIScode: "调用计数器",
        Dedicatedkey: "专用密钥",
        Logicalname: "逻辑名称引用",
      ...
      cosem: {
        ...
        signal_add: "单个添加",
        list_select: "从列表中选择",
        cosem_value_name: "COSEM Value name",
        OBIS_Code: "OBIS Code/Short Name",
        device: "物理设备",
        COSEM_Group_Configuration: "COSEM Group Configuration",
        COSEM_VALUE_list: "COSEM VALUE list",
        COSEM_VALUE: "COSEM VALUE",
        short_name: "short name",
        classId: "类ID",
        scan: "扫描",
        enteries: "条目数",

        duplicateName: "COSEM Value 名称不能重复",
        duplicateCODEclassId: "OBIS Code 和 Class ID 不能重复",
      },
      forward: {
        title: "forward",
        add_connection: "添加连接",
        ...
        data_filter: "数据筛选",
        json_flags: "JSON标志",
        send_as_object: "作为对象发送",
        format_string: "自定义格式",
        cosem_group_ids: "COSEM组",
  ...
  app: {
    ...
    python: {
      ...
      app: {
        ...
        debugtype: "Debug文件",
        importtip:
          "Python将会在导入App包时停止运行并在导入成功后重启。确认导入？",
        confirm: "确认",
        tip: [
          {
            title: "App包",
  ...
  tip: {
    datatype: {
      HTTP_Header: "请输入正确的HTTP报头形式，如：Content-Type:application/json",
      url: "请输入正确的URL格式",
      obis_code: "请输入A.B.C.D.E.F格式的OBIS地址，或0~65535之间的值",
      OBISCODE: "请输入正确的OBIS Code",
      dlms: "不允许输入空格，问号，“；”和“（” ",
      integer: "只允许填写整数",
      digital: "只允许填写数字",
      dialcode: "只能输入 * 和 0-9.",
      ...
      "ipv4|ipv6": "无效的IP地址",
      multiipv4:
        "多IP地址，格式为：x.x.x.x or x.x.x.x x.x.x.x or x.x.x.x,x.x.x.x.",
      ...
      radiusKey:
        "支持输入1-127位的数字、英文大小写、ASCII码除了空格、逗号、单引号、分号、左括号以外的其他字符",
      mqtt_password: "只允许输入英文、数字、空格、%=&._/!#*+,-:<>@[]^_{}~",
      backet: "不允许输入括号",
      cidr: "需要输入形式为x.x.x.x/xx",
    },
    empty: "该字段必填",
    param: "参数无效",
    save_fail: "保存失败，请重试",
    ...
    change_ip_tip:
      "连接断开，您的IP地址已更改。<br/> 请使用正确的IP地址重新登录。",
    connect_fail_tip:
      "连接断开，您的网络异常或者IP地址已更改。<br/> 请尝试刷新页面或者用正确的IP地址重新登录。",
    mqttsame: "MQTT转发规则重复",
  ...
  code: {
    ...
    10040002: "名称重复",
    10040003: "超过添加的最大上限值",
    10040004: "已经被使用，无法修改/删除",
    10040005: "未找到 无法修改/删除",
    10040006: "失败",
    10040007: "服务器地址,逻辑服务器地址的值已存在",
    10040008: "obis_code已存在",
    10040009: "请检查串口配置",
  },
  operation: {
    operation: "操作",
