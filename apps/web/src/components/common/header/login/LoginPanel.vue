...
.login-panel {
  ...
  .login-panel-body {
    ...
    .login-panel-image {
      ...
      width: 270px;
      height: 100%;
      background-image: url('https://youyu-source.youyul.com/youyu/background/gaoqi_hangpai.jpg');
...
/* .dark-theme {
    .login-panel-image {
      background-image: url('https://youyu-source.youyul.com/youyu/login/tulip.jpg') !important;
    }
  } */
</style>
