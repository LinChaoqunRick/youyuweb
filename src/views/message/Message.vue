      ...
      >
        <div class="form-top">
          <a-form-item class="nickname-item" label="昵称" name="nickname">
            <a-input v-model:value="formState.nickname" size="large" placeholder="必填：请输入昵称" />
          </a-form-item>

          <a-form-item class="email-item" label="邮箱" name="email">
            <a-input v-model:value="formState.email" size="large" placeholder="必填：请输入邮箱" />
          </a-form-item>

          <a-form-item class="home-item" label="主页" name="home">
            <a-input v-model:value="formState.home" size="large" placeholder="选填：请输入主页" />
          </a-form-item>
