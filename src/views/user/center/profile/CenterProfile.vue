  ...
  <div class="center-profile">
    ...
    <div class="center-content">
      <div class="content-form">
        ...
        >
          ...
          <a-form-item label="个人描述" name="signature">
            <a-textarea v-model:value="formValidate.signature" :rows="3" show-count :maxlength="100" />
          </a-form-item>
      ...
      <div class="content-right">
        ...
        <div class="avatar-tips">支持 jpg、png、jpeg 格式大小 5M 以内的图片</div>
      </div>
    </div>
  </div>
</template>
...
async function onSubmit() {
  await dispatch('saveBasicInfo', formValidate.value)
    .then(res => {
